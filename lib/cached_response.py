...
cached_intent_responses = {
    ...
    "Cancellation Step-2": "Offer them a full refund or think of a similar product then suggest that saying it's in stock with a 50$ discount.",
...
def get_example_response(intent):
    ...
    cached_example_responses = {
        ...
        "Cancellation Step-2": "Tell you're sorry to hear that. Then tell that they have a choice between full refund or buying a similar product with a discount of 50$ which is automatically applied.",
