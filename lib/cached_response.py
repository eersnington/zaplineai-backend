...
class VectorDatabase:
    def __init__(self):
        ...
        self.cached_responses = {
            "I wanna know the status": "Of course Based on our records, <<explain the current status of your order>>",
            ...
            "Where is my order?": "Of course Based on our records, <<explain the current status of your order>>",
            "What's the status of my order?": "I can check that for you. Based on our records, <<explain the current status of your order>>",
            "What is the shipping status of my order?": "Of course Based on our records, <<explain the current status of your order>>",
            "What is the shipment status?": "Of course Based on our records, <<explain the current status of your order>>",
            "Where's my order?": "Alright! Based on our records, <<explain the current status of your order>>",            
            "Where is my package?": "Alright! Based on our records, <<explain the current status of your order>>",
            "Where is my shipment?": "Alright! Based on our records, <<explain the current status of your order>>",
            "Where are my items?": "Alright! Based on our records, <<explain the current status of your order>>",
            "My order hasn't arrived yet": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            "I haven't got my order yet": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            "I haven't got my package yet": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            "I haven't got my shipment yet": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            "I haven't received my order yet": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",            
            "I haven't received my package yet": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            "I haven't received my shipment yet": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            "Can you update me on my order?": "No worries! I'll check on that for you. Based on our records, <<explain the current status of your order>>",
            ...
            "I'm checking on my order's delivery status.": "Of course Based on our records, <<explain the current status of your order>>",
            ...
            "I'm still waiting for my order.": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            ...
            "I need to track my order.": "Of course Based on our records, <<explain the current status of your order>>",
            "I'm waiting for my order.": "Sorry to hear that. Based on our records, <<explain the current status of your order>>",
            ...
            "I need to know when to expect my order.": "Sure thing! Based on our records, <<explain the current status of your order>>",
