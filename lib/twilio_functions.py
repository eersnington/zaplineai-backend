...
async def call_accept(request:Request, public_url: str, phone_number: str) -> VoiceResponse:
    ...
    response_text = f"Hi There! Thank you for contacting clothing store."
            ...
            if packet['event'] == 'start':
                ...
                if is_speech:
                    ...
                    if is_bot_speaking:
                        ...
                        audio_buffer.clear()
                        # ... (Transcription and response handling)
