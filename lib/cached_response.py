...
cached_intent_responses = {
    ...
    "Cancellation Step-2": "Ask them if they want a full refund, or suggest 2 similar products which is in stock (for example if customer ordered black hoodie, then you can say that we have a grey or white in stock that will ship fast) and also offer a 50$ discount that will be auto applied",
